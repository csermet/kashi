<!-- VENDORED from https://github.com/tranxuanthang/lrclib/blob/master/LYRICSFILE_IMPLEMENTATION_PLAN.md
     upstream commit: 3f68e7cda086 2026-06-24T02:40:02Z | vendored: 2026-07-13 (Faz 5 P3)
     Upstream warns "expect breaking changes" — the weekly AI report watches the repo.
     Parser contract: version major 1 only; on any mismatch fall back to syncedLyrics. -->
